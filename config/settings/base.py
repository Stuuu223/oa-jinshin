    ...
    "menus": [
        ...
        },
        {
            ...
            "models": [
                ...
                {"name": "客户公海池", "url": "/admin/customers/customer/?status__exact=pool", "icon": "fa fa-globe"},
                {"name": "回收站", "url": "/admin/customers/recycledcustomer/", "icon": "fa fa-trash-o", "permission": "accounts.view_user"},
